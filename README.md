...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/winter-dawn-63a6)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/winter-dawn-63a6
```

A live public deployment of this template is available at [https://winter-dawn-63a6.templates.workers.dev](https://winter-dawn-63a6.templates.workers.dev)
